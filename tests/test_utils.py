...
class TestConvertAmount(unittest.TestCase):
    ...
    def test_rub_amount(self) -> None:
        ...
        self.assertEqual(sum_amount(operation), 100.00)
    ...
    def test_usd_amount(self) -> None:
        with Mocker() as mock:
            ...
            self.assertEqual(sum_amount(operation), 7500.00)
    ...
    def test_eur_amount(self) -> None:
        with Mocker() as mock:
            ...
            self.assertEqual(sum_amount(operation), 8500.00)
